            ...
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row items-start lg:gap-32">
                    <div>
                        ...
                        <div>
                            <button className="btn btn-primary text-white text-base hover:bg-info transition ease-in-out duration-300 mr-4">Get Resume</button>
                            <button className="btn btn-primary text-white text-base hover:bg-info transition ease-in-out duration-300">My Portfolio</button>
                        </div>
                    </div>
                    <img className='rounded-lg hover:scale-110 transition ease-in-out duration-700 scale-' src={PortfolioImg} alt='img of programmer abu jakaria' />
                </div>
            </div>
