                ...
                <div className="hero-content grid lg:grid-cols-2">
                    ...
                    <div>
                        <form action="https://formspree.io/f/xqknjqqz" method="POST" className='text-center mt-8'>
                            ...
                            <textarea class="textarea textarea-primary min-w-full h-40 rounded-md p-2 text-white  bg-neutral input-bordered border border-slate-600 resize-none" name="message" cols="30" rows="10" placeholder='Your Message' required></textarea>

                            <button className='btn btn-primary text-white text-base px-5 py-1 rounded font-bold ml-2'>Send Message</button>
                        </form>
                    </div>
